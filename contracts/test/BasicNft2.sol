 ...
 * @notice The BasicNft2 Smart Contract
...
contract BasicNft2 is ERC721 {
    ...
    /**
     * @dev BasicNft2 contract constructor.
     * Create ERC721 `BasicNft2` contract with given NFT name and symbol.
     */
     ...
     * @dev Function allows user to safe mint BasicNft2 with subsequent tokenId number.
