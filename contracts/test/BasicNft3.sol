...
//  Errors  //
//////////////
error BasicNft3__ReceivedTransferReverted();
error BasicNft3__InvalidFunctionCall();
...
contract BasicNft3 is ERC721 {
    ...
    receive() external payable {
        revert BasicNft3__ReceivedTransferReverted();
    }
    ...
    fallback() external payable {
        revert BasicNft3__InvalidFunctionCall();
    }
}
