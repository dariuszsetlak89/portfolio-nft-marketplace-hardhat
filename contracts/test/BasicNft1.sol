...
//  Errors  //
//////////////
error BasicNft1__ReceivedTransferReverted();
error BasicNft1__InvalidFunctionCall();
...
contract BasicNft1 is ERC721 {
    ...
    receive() external payable {
        revert BasicNft1__ReceivedTransferReverted();
    }
    ...
    fallback() external payable {
        revert BasicNft1__InvalidFunctionCall();
    }
}
